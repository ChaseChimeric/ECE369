...
HD_PWD='C:/Users/ryfon/Documents/Code/comp/ECE369/Lab_4/frank2022/frank2022.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log WinRARTop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source WinRARTop.tcl -notrace
