...
# The value remains 0 until the sum calculation is complete (after the third iteration)
# After this, it stores the sum 1 in the memory location
# 
...
# This stores the address of the current value in the array during execution
#
#
