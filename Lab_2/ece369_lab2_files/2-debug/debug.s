...
# char is the character we are counting and this is stored in t3
# t2 is the current running total of the character we are searching for
# t1 is the current character pointer within the string we are searching
# t0 is the current character in the string
#
# 2. Currently, the program is stuck in an infinite loop. Make use of 
#    breakpoints to locate, and correct the error.
# We corrected the error by incrementing the index pointer properly
